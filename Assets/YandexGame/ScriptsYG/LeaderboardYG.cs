        ...
        void OnUpdateLB(string _name, string entriesLB, int[] rank, string[] photo, string[] playersName, int[] scorePlayers, bool auth)
        {
            ...
            else if (_name == nameLB)
            {
                ...
                else
                {
                    ...
                    if (entriesLB == "No data")
                    {
                        sampleContainer.transform.Find("Rank").GetComponentInChildren<TextMeshProUGUI>().text = "";
                        sampleContainer.transform.Find("Score").GetComponentInChildren<TextMeshProUGUI>().text = "";
                        sampleContainer.transform.Find("Name").GetComponentInChildren<TextMeshProUGUI>().text = error;
                    }
                    else
                    {
                        ...
                        for (int i = 0; i < rank.Length; i++)
                        {
                            ...
                            sampleContainer.transform.Find("Rank").GetComponentInChildren<TextMeshProUGUI>().text = rank[i].ToString();
                            sampleContainer.transform.Find("Name").GetComponentInChildren<TextMeshProUGUI>().text = CheckName(playersName[i]);

                            if (!timeTypeConvert)
                                sampleContainer.transform.Find("Score").GetComponentInChildren<TextMeshProUGUI>().text = scorePlayers[i].ToString();
                            else
                            {
                                string timeScore = TimeTypeConvert(scorePlayers[i]);
                                sampleContainer.transform.Find("Score").GetComponentInChildren<TextMeshProUGUI>().text = timeScore;
                            }
